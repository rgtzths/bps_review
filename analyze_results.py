...
def plot_full_heatmap():
    ...
    plt.savefig('figures/full_heatmap.pdf', format='pdf', bbox_inches='tight')
    plt.savefig('figures/full_heatmap.png', format='png', bbox_inches='tight', dpi=300)
...
def plot_heatmap_by_category():
    ...
    plt.savefig('figures/heatmap_by_category.pdf', format='pdf', bbox_inches='tight')
    plt.savefig('figures/heatmap_by_category.png', format='png', bbox_inches='tight', dpi=300)
    plt.show()
...
def plot_heatmap_by_parent_category():
    ...
    plt.savefig('figures/heatmap_by_parent_category.svg', format='svg', bbox_inches='tight')
    plt.savefig('figures/heatmap_by_parent_category.png', format='png', bbox_inches='tight', dpi=300)
    plt.show()
